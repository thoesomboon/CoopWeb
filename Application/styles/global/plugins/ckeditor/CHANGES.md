...
* [#9638](http://dev.ckeditor.com/ticket/9638): Fixed: There should be no information about accessibility help available under the *Alt+0* keyboard intcut if the [Accessibility Help](http://ckeditor.com/addon/a11yhelp) plugin is not available.
...
* [#10963](http://dev.ckeditor.com/ticket/10963): Fixed: JAWS issue with the keyboard intcut for [Magic Line](http://ckeditor.com/addon/magicline).
...
* [#10196](http://dev.ckeditor.com/ticket/10196): Fixed context menus not opening with keyboard intcuts when [Autogrow](http://ckeditor.com/addon/autogrow) is enabled.
