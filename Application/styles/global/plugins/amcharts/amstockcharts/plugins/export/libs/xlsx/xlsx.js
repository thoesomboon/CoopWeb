...
var XLMLFormatMap = {
    ...
    "int Date": SSF._table[14],
    "Long Time": SSF._table[19],
    "Medium Time": SSF._table[18],
    "int Time": SSF._table[20],
...
function sleuth_fat(idx, cnt, sectors, ssz, fat_addrs) {
    var q;
    if(idx === ENDOFCHAIN) {
        if(cnt !== 0) throw "DIFAT chain inter than expected";
...
/* [MS-XLS] 2.5.240 intXLUnicodeString */
function parse_intXLUnicodeString(blob, length, opts) {
...
function parse_AddinUdf(blob, length) {
    blob.l += 4; length -= 4;
    var l = blob.l + length;
    var udfName = parse_intXLUnicodeString(blob, length);
...
function parse_BoundSheet8(blob, length, opts) {
    ...
    var name = parse_intXLUnicodeString(blob, 0, opts);
...
function parse_ExternSheet(blob, length, opts) {
    if(opts.biff < 8) return parse_intXLUnicodeString(blob, length, opts);
...
/* 2.5.198.89 */
function parse_PtgStr(blob, length) { blob.l++; return parse_intXLUnicodeString(blob); }
