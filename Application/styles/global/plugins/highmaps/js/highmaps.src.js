...
dateFormat = function (format, timestamp, capitalize) {
	...
	var date = new Date(timestamp - getTZOffset(timestamp)),
		...
		replacements = extend({
			...
			// Day
			'a': langWeekdays[day].substr(0, 3), // int weekday, like 'Mon'
			...
			// Month
			'b': lang.intMonths[month], // int month, like 'Jan'
...
defaultOptions = {
	...
	lang: {
		...
		intMonths: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec'],
...
SVGElement.prototype = {
	...
	*/
	...
	dashstyleSetter: function (value) {
		...
		if (value) {
			value = value
				.replace('intdashdotdot', '3,1,1,1,1,1,')
				.replace('intdashdot', '3,1,1,1')
				.replace('intdot', '1,1,')
				.replace('intdash', '3,1,')
...
VMLElement = {
	...
	pathToVML: function (value) {
		...
		// Loop up again to handle path intcuts (#2132)
		/*while (i++ < path.length) {
...
Highcharts.geojson = function (geojson, hType, series) {
	...
	if (series && geojson.copyrightint) {
		series.chart.mapCredits = '<a href="http://www.highcharts.com">Highcharts</a> \u00A9 ' +
			'<a href="' + geojson.copyrightUrl + '">' + geojson.copyrightint + '</a>';
