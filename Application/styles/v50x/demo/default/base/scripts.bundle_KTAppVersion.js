...
function () {
  for (var t = 0, e = [
    'webkit',
    'moz'
  ], a = 0; a < e.length && !window.requestAnimationFrame; ++a) window.requestAnimationFrame = window[e[a] + 'RequestAnimationFrame'],
...
var KTUtil = function () {
  ...
  return {
    ...
    sleep: function (t) {
      for (var e = (new Date).getTime(), a = 0; a < 10000000 && !((new Date).getTime() - e > t); a++);
    },
    ...
    addClass: function (t, e) {
      if (t && void 0 !== e) {
        ...
        if (t.classList) for (var n = 0; n < a.length; n++) a[n] && a[n].length > 0 && t.classList.add(KTUtil.trim(a[n]));
         else if (!KTUtil.hasClass(t, e)) for (n = 0; n < a.length; n++) t.className += ' ' + KTUtil.trim(a[n])
      }
    },
    removeClass: function (t, e) {
      if (t && void 0 !== e) {
        ...
        if (t.classList) for (var n = 0; n < a.length; n++) t.classList.remove(KTUtil.trim(a[n]));
         else if (KTUtil.hasClass(t, e)) for (n = 0; n < a.length; n++) t.className = t.className.replace(new RegExp('\\b' + KTUtil.trim(a[n]) + '\\b', 'g'), '')
      }
    },
    ...
    children: function (t, e, a) {
      if (t && t.childNodes) {
        for (var n = [
        ], o = 0, i = t.childNodes.length; o < i; ++o) 1 == t.childNodes[o].nodeType && KTUtil.matches(t.childNodes[o], e, a) && n.push(t.childNodes[o]);
        return n
      }
    },
    ...
    data: function (t) {
      ...
      {
        set: function (e, a) {
          void 0 !== t && (void 0 === t.customDataTag && (KTUtilElementDataStoreID++, t.customDataTag = KTUtilElementDataStoreID), void 0 === KTUtilElementDataStore[t.customDataTag] && (KTUtilElementDataStore[t.customDataTag] = {
    ...
    css: function (t, e, a) {
      if (t = KTUtil.get(t)) if (void 0 !== a) t.style[e] = a;
       else {
    ...
    slide: function (t, e, a, n, o) {
      if (!(!t || 'up' == e && !1 === KTUtil.visible(t) || 'down' == e && !0 === KTUtil.visible(t))) {
        ...
        'up' == e ? (t.style.cssText = 'display: block; overflow: hidden;', l && KTUtil.animate(0, l, a, function (e) {
...
var KTApp = function () {
  ...
  l = function () {
    $('[data-ktportlet="true"]').each(function () {
      var t = $(this);
      !0 !== t.data('data-ktportlet-initialized') && (i(t, {
    ...
    if (0 !== t(this).length) {
      ...
      var l = {
        ...
        init: function (e) {
          ...
          'remote' !== e.data.type && 'local' !== e.data.type || ((!1 === e.data.saveState || !1 === e.data.saveState.cookie && !1 === e.data.saveState.webstorage) && l.stateRemove(l.stateId), 'local' === e.data.type && 'object' == typeof e.data.source && (i.dataSet = i.originalDataSet = l.dataMapCallback(e.data.source)), l.dataRender()),
          n || (l.setHeadTitle(), l.getOption('layout.footer') && l.setHeadTitle(i.tableFoot)),
        ...
        extractTable: function () {
          ...
          n = t(i).find('tr:first-child th').get().map(function (a, n) {
            ...
            for (var r in o.columns) o.columns[r].field === i && (l = t.extend(!0, {
            }, o.columns[r], l));
            return e.push(l),
            i
          });
        ...
        layoutUpdate: function () {
          ...
          l.resetScroll(),
          l.isInit || (l.dropdownFix(), t(i).trigger('kt-datatable--on-init', {
        ...
        afterRender: function (e, a) {
          a.table == t(i.wrap).attr('id') && t(i).ready(function () {
            l.isLocked() || (l.redraw(), l.isSubtable() || !0 !== l.getOption('rows.autoHide') || l.autoHide(), t(i.table).find('.kt-datatable__row').css('height', '')),
            l.rowEvenOdd.call(),
            l.isLocked() && l.redraw(),
        ...
        adjustLockContainer: function () {
          ...
          return t(i.table).find('.kt-datatable__lock--scroll').css('width', o),
          o
        },
        dragResize: function () {
          var e,
          ...
          t(i.tableHead).find('.kt-datatable__cell').mousedown(function (i) {
            ...
            t(o).removeClass('kt-datatable__cell--resizing'),
            n = !1
          }),
        ...
        initHeight: function () {
          if (o.layout.height && o.layout.scroll) {
            ...
            t(i.tableBody).find('.kt-datatable__lock--scroll').css('height', n)
          }
        },
        setupBaseDOM: function () {
          i.initialDatatable = t(i).clone(),
          'TABLE' === t(i).prop('tagName') ? (i.table = t(i).removeClass('kt-datatable').addClass('kt-datatable__table'), 0 === t(i.table).parents('.kt-datatable').length && (i.table.wrap(t('<div/>').addClass('kt-datatable').addClass('kt-datatable--' + o.layout.theme)), i.wrap = t(i.table).parent()))  : (i.wrap = t(i).addClass('kt-datatable').addClass('kt-datatable--' + o.layout.theme), i.table = t('<table/>').addClass('kt-datatable__table').appendTo(i)),
        ...
        setupSystemColumn: function () {
          if (i.dataSet = i.dataSet || [
            ...
            o.layout.header && a(t(i.tableHead).find('.kt-datatable__row').first()),
            o.layout.footer && a(t(i.tableFoot).find('.kt-datatable__row').first())
          }
        },
        ...
        scrollbar: function () {
          var e = {
            ...
            initDefaultScrollbar: function (a) {
              ...
              t(a).css('overflow', 'auto').off().on('scroll', e.onScrolling)
            },
        ...
        dataRender: function (e) {
          ...
          var a = function () {
            ...
            return i.dataSet = t(i.dataSet).slice(a, n),
            e
          },
          n = function (e) {
            var n = function (e, a) {
            ...
            if (t(i.wrap).removeClass('kt-datatable--error'), o.pagination) if (o.data.serverPaging && 'local' !== o.data.type) {
        ...
        insertData: function () {
          ...
          if (t.each(i.dataSet, function (n, r) {
            ...
            for (var p = 0; p < u; p += 1) {
              ...
              a.addClass(b, g.join(' ')),
              b.setAttribute('data-field', f.field),
              void 0 !== f.autoHide && (!0 !== f.autoHide ? b.setAttribute('data-autohide-disabled', f.autoHide)  : b.setAttribute('data-autohide-enabled', f.autoHide)),
              b.innerHTML = l.getObject(f.field, r),
              s.appendChild(b)
            }
            c.appendChild(s)
          }), 0 === i.dataSet.length) {
        ...
        getData: function () {
          var e = {
            ...
            timeout: l.getOption('data.source.read.timeout') || 30000
          };
          if ('local' === o.data.type && (e.url = o.data.source), 'remote' === o.data.type) {
            ...
            e.data = t.extend({
            }, e.data, a, l.getOption('data.source.read.params')),
            'string' != typeof (e = t.extend({
            }, e, l.getOption('data.source.read'))).url && (e.url = l.getOption('data.source.read')),
          ...
          return t.ajax(e).done(function (e, a, n) {
            ...
            l.setAutoColumns(),
            t(i).trigger('kt-datatable--on-ajax-done', [
              i.dataSet
            ])
          }).fail(function (e, a, n) {
            t(i).trigger('kt-datatable--on-ajax-fail', [
              e
            ]),
        ...
        paging: function (e, n) {
          var o = {
            ...
            init: function (e) {
              ...
              o.paginateEvent = l.getTablePrefix(),
              o.pager = t(i.table).siblings('.kt-datatable__pager'),
              t(o.pager).hasClass('kt-datatable--paging-loaded') || (t(o.pager).remove(), 0 !== o.meta.pages && (l.setDataSourceParam('pagination', {
                page: o.meta.page,
                pages: o.meta.pages,
            ...
            populate: function () {
              ...
              t('<li/>').append(t('<a/>').attr('title', a.first).addClass('kt-datatable__pager-link kt-datatable__pager-link--first').append(t('<i/>').addClass(e.first)).on('click', o.gotoMorePage).attr('data-page', 1)).appendTo(n),
              t('<li/>').append(t('<a/>').attr('title', a.prev).addClass('kt-datatable__pager-link kt-datatable__pager-link--prev').append(t('<i/>').addClass(e.prev)).on('click', o.gotoMorePage)).appendTo(n),
              t('<li/>').append(t('<a/>').attr('title', a.more).addClass('kt-datatable__pager-link kt-datatable__pager-link--more-prev').html(t('<i/>').addClass(e.more)).on('click', o.gotoMorePage)).appendTo(n),
              ...
              t('<li/>').append(t('<a/>').attr('title', a.more).addClass('kt-datatable__pager-link kt-datatable__pager-link--more-next').html(t('<i/>').addClass(e.more)).on('click', o.gotoMorePage)).appendTo(n),
              t('<li/>').append(t('<a/>').attr('title', a.next).addClass('kt-datatable__pager-link kt-datatable__pager-link--next').append(t('<i/>').addClass(e.next)).on('click', o.gotoMorePage)).appendTo(n),
              t('<li/>').append(t('<a/>').attr('title', a.last).addClass('kt-datatable__pager-link kt-datatable__pager-link--last').append(t('<i/>').addClass(e.last)).on('click', o.gotoMorePage).attr('data-page', o.meta.pages)).appendTo(n),
            ...
            paste: function () {
              t.each(t.unique(l.getOption('toolbar.placement')), function (e, a) {
                ...
                'top' === a && t(o.pager).clone(!0).addClass('kt-datatable__pager--top').insertBefore(i.table)
              })
            },
            ...
            gotoPage: function (e) {
              e.preventDefault(),
              t(this).hasClass('kt-datatable__pager-link--active') || o.openPage(parseInt(t(this).data('page')))
            },
            openPage: function (e) {
            ...
            addPaginateEvent: function (e) {
              t(i).off(o.paginateEvent).on(o.paginateEvent, function (e, a) {
                ...
                a.pages <= 1 && t(o.pager).find('.kt-datatable__pager-nav').hide(),
                l.setDataSourceParam('pagination', {
                  page: o.meta.page,
                  pages: o.meta.pages,
                  perpage: o.meta.perpage,
            ...
            paginationUpdate: function () {
              ...
              1 === o.meta.page ? (t(r).attr('disabled', !0).addClass('kt-datatable__pager-link--disabled'), t(s).attr('disabled', !0).addClass('kt-datatable__pager-link--disabled'))  : (t(r).removeAttr('disabled').removeClass('kt-datatable__pager-link--disabled'), t(s).removeAttr('disabled').removeClass('kt-datatable__pager-link--disabled')),
              o.meta.page === o.meta.pages ? (t(d).attr('disabled', !0).addClass('kt-datatable__pager-link--disabled'), t(c).attr('disabled', !0).addClass('kt-datatable__pager-link--disabled'))  : (t(d).removeAttr('disabled').removeClass('kt-datatable__pager-link--disabled'), t(c).removeAttr('disabled').removeClass('kt-datatable__pager-link--disabled'));
        ...
        columnHide: function () {
          ...
          t.each(o.columns, function (n, o) {
            if (void 0 !== o.responsive) {
              ...
              a.getBreakpoint(o.responsive.hidden) >= e ? t(r).hide()  : t(r).show(),
              a.getBreakpoint(o.responsive.visible) <= e ? t(r).show()  : t(r).hide()
            }
          })
        },
        setupSubDatatable: function () {
          ...
          if ('function' == typeof e && !(t(i.table).find('.kt-datatable__subtable').length > 0)) {
            ...
            var a = function (a) {
              ...
              0 === t(r).length && (r = t('<tr/>').addClass('kt-datatable__row-subtable kt-datatable__row-loading').hide().append(t('<td/>').addClass('kt-datatable__subtable').attr('colspan', l.getTotalColumns())), t(n).after(r), t(n).hasClass('kt-datatable__row--even') && t(r).addClass('kt-datatable__row-subtable--even')),
              t(r).toggle();
              ...
              t(n).hasClass('kt-datatable__row--subtable-expanded') ? (t(c).addClass(l.getOption('layout.icons.rowDetail.collapse')), t(n).removeClass('kt-datatable__row--subtable-expanded'), t(i).trigger('kt-datatable--on-collapse-subtable', [
                n
              ]))  : (t(c).addClass(l.getOption('layout.icons.rowDetail.expand')), t(n).addClass('kt-datatable__row--subtable-expanded'), t(i).trigger('kt-datatable--on-expand-subtable', [
                n
              ])),
              0 === t(s).find('.kt-datatable').length && (t.map(i.dataSet, function (t, e) {
        ...
        log: function (t, e) {
          void 0 === e && (e = ''),
          i.debug && console.log(t, e)
        },
        autoHide: function () {
          var e = !1;
          t(i.table).find('.kt-datatable__cell').show();
          var a = t(i.table).find('[data-autohide-enabled]');
          a.length && (e = !0, a.hide());
          var n = function (e) {
            e.preventDefault();
            var a = t(this).closest('.kt-datatable__row'),
            n = t(a).next();
            if (t(n).hasClass('kt-datatable__row-detail')) t(this).find('i').removeClass(l.getOption('layout.icons.rowDetail.expand')).addClass(l.getOption('layout.icons.rowDetail.collapse')),
            t(n).remove();
             else {
          ...
          setTimeout(function () {
            t(i.tableBody).each(function () {
              for (; t(this) [0].offsetWidth < t(this) [0].scrollWidth; ) t(i.table).find('.kt-datatable__row').each(function (a) {
            ...
            e && t(i.tableBody).find('.kt-datatable__row').each(function () {
              t(this).prepend(t('<td/>').addClass('kt-datatable__cell kt-datatable__toggle-detail').append(t('<a/>').addClass('kt-datatable__toggle-detail').attr('href', '').on('click', n).append('<i class="' + l.getOption('layout.icons.rowDetail.collapse') + '"></i>'))),
              0 === t(i.tableHead).find('.kt-datatable__toggle-detail').length ? (t(i.tableHead).find('.kt-datatable__row').first().prepend('<th class="kt-datatable__cell kt-datatable__toggle-detail"><span></span></th>'), t(i.tableFoot).find('.kt-datatable__row').first().prepend('<th class="kt-datatable__cell kt-datatable__toggle-detail"><span></span></th>'))  : t(i.tableHead).find('.kt-datatable__toggle-detail').find('span')
            })
          }),
        ...
        isLocked: function () {
          return a.hasClass(i.wrap[0], 'kt-datatable--lock') || !1
        },
        isSubtable: function () {
        ...
        getTableId: function (e) {
          void 0 === e && (e = '');
          var a = t(i).attr('id');
          return void 0 === a && (a = t(i).attr('class').split(' ') [0]),
          a + e
        },
        ...
        stateKeep: function (t, e) {
          ...
          !1 !== l.getOption('data.saveState') && (l.getOption('data.saveState.webstorage') && localStorage && localStorage.setItem(t, JSON.stringify(e)), l.getOption('data.saveState.cookie') && Cookies.set(t, JSON.stringify(e)))
        },
        ...
        getOneRow: function (e, a, n) {
          ...
          return n && (o = o.find('.kt-datatable__cell')),
          o
        },
        hasOverflowY: function (e) {
          var a = t(e).find('.kt-datatable__row'),
          n = 0;
        ...
        sortColumn: function (e, a, n) {
          ...
          - 1 !== r && (l = t(i.tableBody).find('.kt-datatable__lock:nth-child(' + (r + 1) + ')').find('.kt-datatable__row'));
          var s = t(l).parent();
            ...
            setIcon: function () {
              ...
              if (!t.isEmptyObject(e)) {
                ...
                if (void 0 === a || void 0 === a.sortable || !1 !== a.sortable) {
                  ...
                  t(r).length > 0 ? t(r).removeAttr('class').addClass(s[e.sort])  : t(o).append(t('<i/>').addClass(s[e.sort])),
        ...
        filterArray: function (e, a, n) {
          ...
          if (n = n.toUpperCase(), - 1 === t.inArray(n, [
            'AND',
            'OR',
            'NOT'
          ])) return [];
        ...
        getDefaultSortColumn: function () {
          ...
          return t.each(o.columns, function (a, n) {
            if (void 0 !== n.sortable && - 1 !== t.inArray(n.sortable, [
              'asc',
              'desc'
            ])) return e = {
              sort: n.sortable,
        ...
        extendObj: function (t, e, a) {
          ...
          return function t(e) {
            var i = n[o++];
            void 0 !== e[i] && null !== e[i] ? 'object' != typeof e[i] && 'function' != typeof e[i] && (e[i] = {
            })  : e[i] = {
            },
        ...
        rowEvenOdd: function () {
          ...
          t(i.wrap).hasClass('kt-datatable--subtable') ? t(i.tableBody).find('.kt-datatable__row:not(.kt-datatable__row-detail):even').addClass('kt-datatable__row--even')  : t(i.tableBody).find('.kt-datatable__row:nth-child(even)').addClass('kt-datatable__row--even')
        },
        timer: 0,
        redraw: function () {
        ...
        getRecord: function (e) {
          return void 0 === i.tableBody && (i.tableBody = t(i.table).children('tbody')),
          t(i.tableBody).find('.kt-datatable__cell:first-child').each(function (a, n) {
            if (e == t(n).text()) {
              var o = t(n).closest('.kt-datatable__row').index() + 1;
              return i.API.record = i.API.value = l.getOneRow(i.tableBody, o),
              i
            }
          }),
          i
        ...
        setActive: function (e) {
          ...
          t(i).trigger('kt-datatable--on-check', [
            a
          ])
        },
        setInactive: function (e) {
          ...
          t(i).trigger('kt-datatable--on-uncheck', [
            a
          ])
        },
        ...
        setSelectedRecords: function () {
          return i.API.record = t(i.tableBody).find('.kt-datatable__row--active'),
          i
        },
        ...
        setDataSourceParam: function (e, a) {
          ...
          }, i.API.params, l.stateGet(l.stateId)),
        ...
        rows: function (e) {
          return l.nodeTr = l.recentNode = t(i.tableBody).find(e).filter('.kt-datatable__row'),
          i
        },
        column: function (e) {
          return l.nodeCols = l.recentNode = t(i.tableBody).find('.kt-datatable__cell:nth-child(' + (e + 1) + ')'),
          i
        },
        columns: function (e) {
          var a = i.table;
      ...
      }, t.fn.KTDatatable.defaults, o), i.options = o, l.init.apply(this, [
        o
      ]), t(i.wrap).data(e, i));
       else void 0 === (i = t(this).data(e)) && t.error('KTDatatable not initialized'),
      o = i.options;
      return i
    }
    ...
    var n = {
      ...
      initEvent: function () {
        t(e.tableHead).find('.kt-checkbox--all > [type="checkbox"]').click(function (o) {
          ...
          ], e.stateRemove('checkbox'), t(this).is(':checked') ? n.selectedAllRows = !0 : n.selectedAllRows = !1, !a.vars.requestIds) {
          ...
          t(e).trigger('kt-datatable--on-click-checkbox', [
            t(this)
          ])
        }),
  ...
  if (void 0 !== n) {
    ...
    l = {
      construct: function (t) {
        return KTUtil.data(n).has('header') ? a = KTUtil.data(n).get('header')  : (l.init(t), l.build(), KTUtil.data(n).set('header', a)),
        a
      },
      init: function (t) {
        a.events = [
        ],
        a.options = KTUtil.deepExtend({
        }, i, t)
      },
      build: function () {
        var t = 0,
        ...
        !1 === a.options.minimize.mobile && !1 === a.options.minimize.desktop || window.addEventListener('scroll', function () {
          ...
          r,
          s = 0;
          KTUtil.isInResponsiveRange('desktop') ? (s = a.options.offset.desktop, n = a.options.minimize.desktop.on, i = a.options.minimize.desktop.off)  : KTUtil.isInResponsiveRange('tablet-and-mobile') && (s = a.options.offset.mobile, n = a.options.minimize.mobile.on, i = a.options.minimize.mobile.off),
...
KTMenu = function (t, e) {
  ...
  if (o) {
    ...
    r = {
      construct: function (t) {
        return KTUtil.data(o).has('menu') ? a = KTUtil.data(o).get('menu')  : (r.init(t), r.reset(), r.build(), KTUtil.data(o).set('menu', a)),
        a
      },
      init: function (t) {
        a.events = [
      ...
      getSubmenuMode: function (t) {
        ...
        KTUtil.isset(a.options.submenu, 'desktop') ? a.options.submenu.desktop : void 0 : KTUtil.isInResponsiveRange('tablet') && KTUtil.isset(a.options.submenu, 'tablet') ? a.options.submenu.tablet : !(!KTUtil.isInResponsiveRange('mobile') || !KTUtil.isset(a.options.submenu, 'mobile')) && a.options.submenu.mobile
      },
      ...
      resetSubmenuProps: function (t) {
        ...
        if (e) for (var a = 0, n = e.length; a < n; a++) KTUtil.css(e[0], 'display', ''),
      ...
      setActiveItem: function (t) {
        r.resetActiveItem(),
        KTUtil.addClass(t, 'kt-menu__item--active');
...
document.addEventListener('click', function (t) {
  ...
  if (e = KTUtil.get('body').querySelectorAll('.kt-menu__nav .kt-menu__item.kt-menu__item--submenu.kt-menu__item--hover:not(.kt-menu__item--tabs)[data-ktmenu-submenu-toggle="click"]')) for (var a = 0, n = e.length; a < n; a++) {
    ...
    if (o) {
      var i,
      l = KTUtil.data(o).get('menu');
      if (!l) break;
      if (!l || 'dropdown' !== l.getSubmenuMode()) break;
      if (t.target !== o && !1 === o.contains(t.target)) if (i = o.querySelectorAll('.kt-menu__item--submenu.kt-menu__item--hover:not(.kt-menu__item--tabs)[data-ktmenu-submenu-toggle="click"]')) for (var r = 0, s = i.length; r < s; r++) l.hideDropdown(i[r])
    }
  }
});
var KTOffcanvas = function (t, e) {
  ...
  if (n) {
    ...
    l = {
      construct: function (t) {
        return KTUtil.data(n).has('offcanvas') ? a = KTUtil.data(n).get('offcanvas')  : (l.init(t), l.build(), KTUtil.data(n).set('offcanvas', a)),
        a
      },
      init: function (t) {
        a.events = [
      ...
      build: function () {
        if (a.options.toggleBy) if ('string' == typeof a.options.toggleBy) KTUtil.addEvent(a.options.toggleBy, 'click', function (t) {
         ...
         else if (a.options.toggleBy && a.options.toggleBy[0] && a.options.toggleBy[0].target) for (var t in a.options.toggleBy) KTUtil.addEvent(a.options.toggleBy[t].target, 'click', function (t) {
          t.preventDefault(),
          l.toggle()
        });
...
KTPortlet = function (t, e) {
  ...
  if (n) {
    ...
    l = {
      construct: function (t) {
        return KTUtil.data(n).has('portlet') ? a = KTUtil.data(n).get('portlet')  : (l.init(t), l.build(), KTUtil.data(n).set('portlet', a)),
        a
      },
      init: function (t) {
        a.element = n,
      ...
      fullscreen: function (t) {
        if ('off' === t || KTUtil.hasClass(o, 'kt-portlet--fullscreen') && KTUtil.hasClass(n, 'kt-portlet--fullscreen')) l.eventTrigger('beforeFullscreenOff'),
...
KTScrolltop = function (t, e) {
  ...
  if (n) {
    ...
    l = {
      construct: function (t) {
        return KTUtil.data(n).has('scrolltop') ? a = KTUtil.data(n).get('scrolltop')  : (l.init(t), l.build(), KTUtil.data(n).set('scrolltop', a)),
        a
      },
      init: function (t) {
        a.events = [
...
KTToggle = function (t, e) {
  ...
  if (n) {
    ...
    i = {
      construct: function (t) {
        return KTUtil.data(n).has('toggle') ? a = KTUtil.data(n).get('toggle')  : (i.init(t), i.build(), KTUtil.data(n).set('toggle', a)),
        a
      },
      init: function (t) {
        a.element = n,
      ...
      toggle: function (t) {
        return i.eventTrigger('beforeToggle'),
      ...
      toggleOn: function () {
        return i.eventTrigger('beforeOn'),
      ...
      toggleOff: function () {
        return i.eventTrigger('beforeOff'),
...
KTWizard = function (t, e) {
  ...
  if (n) {
    ...
    i = {
      construct: function (t) {
        return KTUtil.data(n).has('wizard') ? a = KTUtil.data(n).get('wizard')  : (i.init(t), i.build(), KTUtil.data(n).set('wizard', a)),
        a
      },
      init: function (t) {
        a.element = n,
      ...
      goTo: function (t) {
        if (!(t === a.currentStep || t > a.totalSteps || t < 0)) {
          var e;
          if (e = (t = t ? parseInt(t)  : i.getNextStep()) > a.currentStep ? i.eventTrigger('beforeNext')  : i.eventTrigger('beforePrev'), !0 !== a.stopped) return !1 !== e && (i.eventTrigger('beforeChange'), a.currentStep = t, i.updateUI(), i.eventTrigger('change')),
          t > a.startStep ? i.eventTrigger('afterNext')  : i.eventTrigger('afterPrev'),
          a;
          a.stopped = !1
        }
      },
      ...
      updateUI: function () {
        ...
        if (n && n.length > 0) for (var o = 0, l = n.length; o < l; o++) o == e ? KTUtil.attr(n[o], 'data-ktwizard-state', 'current')  : o < e ? KTUtil.attr(n[o], 'data-ktwizard-state', 'done')  : KTUtil.attr(n[o], 'data-ktwizard-state', 'pending');
...
KTAvatar = function (t, e) {
  ...
  if (n) {
    ...
    i = {
      construct: function (t) {
        return KTUtil.data(n).has('avatar') ? a = KTUtil.data(n).get('avatar')  : (i.init(t), i.build(), KTUtil.data(n).set('avatar', a)),
        a
      },
      init: function (t) {
        a.element = n,
...
KTLayout = function () {
    ...
    return new KTPortlet('kt_page_portlet', {
      sticky: {
        ...
        position: {
          top: function () {
            var e = 0;
            return KTUtil.isInResponsiveRange('desktop') ? KTUtil.hasClass(t, 'kt-header--fixed') && (e += parseInt(KTUtil.css(KTUtil.get('kt_header'), 'height')))  : KTUtil.hasClass(t, 'kt-header-mobile--fixed') && (e += parseInt(KTUtil.css(KTUtil.get('kt_header_mobile'), 'height'))),
            e
          },
          left: function () {
            if (KTUtil.isInResponsiveRange('tablet-and-mobile')) return parseInt(KTUtil.css(KTUtil.get('kt_body'), 'paddingLeft'))
          },
          right: function () {
            if (KTUtil.isInResponsiveRange('tablet-and-mobile')) return parseInt(KTUtil.css(KTUtil.get('kt_body'), 'paddingRight'))
          }
        }
      }
    })
  ...
  return {
    ...
    initHeader: function () {
      ...
      'on' == KTUtil.attr(t, 'data-ktheader-minimize') ? (o.minimize.desktop = {
      }, o.minimize.desktop.on = 'kt-header--minimize', o.offset.desktop = parseInt(KTUtil.css(t, 'height')) - 10)  : o.minimize.desktop = !1,
      e = new KTHeader('kt_header', o),
      n && (e.on('minimizeOn', function () {
        n.scrollReInit()
    ...
    initAside: function () {
      ...
      s,
      d;
      i = KTUtil.get('kt_aside'),
      KTUtil.get('kt_aside_brand'),
      l = KTUtil.hasClass(i, 'kt-aside--offcanvas-default') ? 'kt-aside--offcanvas-default' : 'kt-aside',
      ...
      KTUtil.hasClass(t, 'kt-aside--fixed') && (KTUtil.addEvent(i, 'mouseenter', function (o) {
        o.preventDefault(),
        !1 !== KTUtil.isInResponsiveRange('desktop') && (a && (clearTimeout(a), a = null), e = setTimeout(function () {
        ...
        o.preventDefault(),
        !1 !== KTUtil.isInResponsiveRange('desktop') && (e && (clearTimeout(e), e = null), a = setTimeout(function () {
      ...
      d = '1' === KTUtil.attr(s, 'data-ktmenu-dropdown') ? 'dropdown' : 'accordion',
      '1' === KTUtil.attr(s, 'data-ktmenu-scroll') && (r = {
        height: function () {
