    ...
    var t = function () {
        var t = $(".m_datatable").mDatatable({
            data: {
                ...
                pageSize: 10, saveState: { cookie: !0, webstorage: !0 }
            }, layout: { theme: "default", class: "", scroll: !1, height: 550, footer: !1 },
            sortable: !0, filterable: !1, pagination: !0,
            columns: [
                { field: "RecordID", title: "#", width: 50, sortable: !1, selector: !1, textAlign: "center" },
                { field: "OrderID", title: "Order ID" },
                { field: "ShipCountry", title: "Ship Country", template: function (t) { return t.ShipCountry + " - " + t.ShipCity } },
                ...
                { field: "ShipDate", title: "Ship Date" },
                {
                    field: "Status", title: "Status", template: function (t) {
                        var e = {
                            1:
                                { title: "Pending", class: "m-badge--brand" }, 2: { title: "Delivered", class: " m-badge--metal" }, 3: { title: "Canceled", class: " m-badge--primary" }, 4: { title: "Success", class: " m-badge--success" }, 5: { title: "Info", class: " m-badge--info" }, 6: { title: "Danger", class: " m-badge--danger" }, 7: { title: "Warning", class: " m-badge--warning" }
        ...
        $("#m_form_search").on("keyup",
            function (e) { t.search($(this).val().toLowerCase()) }).val(e.generalSearch),
...
}(); jQuery(document).ready(function () { DatatableJsonRemoteDemo.init() });